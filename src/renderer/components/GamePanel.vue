<template>
  <section class="panel panel-game">
    <div class="game-content">
      <div class="gamebar">
        <div class="gamebar-chip">
          {{ quizOptions.mode === 'flag-to-country' ? 'Trouver le pays' : 'Trouver le drapeau' }}
        </div>
        <div class="gamebar-meta">
          <span class="gamebar-item">Q {{ questionIndex }}/{{ totalQuestions }}</span>
          <span class="gamebar-item score">Score {{ score }}</span>
        </div>
      </div>

      <transition name="fade">
        <div v-if="currentQuestion" key="question" class="gamebody">
    ...
    <footer class="footer game-actions">
      <p class="message">
        {{ message }}
      </p>
